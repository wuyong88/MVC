...
$data = select("select n.*,c.name from news as n left join news_cates as c on n.cate_id=c.id order by id desc limit $start,$count");
...
require 'app/view/admin/news/index.html';
